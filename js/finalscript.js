jQuery(document).ready(function ($) {
  ...
  let compositions1Html = compositions1.html(); // 3 divs
  let finalHtml = "";

  let compositions = $(".composition-container__2,.composition-container__3"); // 7 divs
